...
export default function CollapsibleCard({
    ...
    return (
        <div className={`rounded-xl border border-[#E4E4E7] overflow-hidden ${className}`}>
            <button type="button" className="flex w-full items-center justify-between px-4 py-3 text-left">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <div className="text-[15px] font-medium text-[#0A0C0F]">{title}</div>
                        {subtitle && <div className="text-[12px] text-[#3D495C]">{subtitle}</div>}
                    </div>
                </div>
