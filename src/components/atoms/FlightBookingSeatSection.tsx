                    ...
                    {eligiblePassengers.map((passenger, index) => {
                      ...
                      return (
                        <div
                          ...
                          className={`rounded-xl border ${isSelected
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            >
                              <div
                                className={`px-2 py-1 rounded text-[12px] font-medium ${hasSeat
                              ...
                              />
                              <span
                                className={`text-[14px] font-medium ${hasSeat ? "text-[#0A0C0F]" : "text-[#C2CAD6]"
                                  }`}
                              >
