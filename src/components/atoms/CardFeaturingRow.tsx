...
export default function CardFeaturingRow({
  airline,
  blocks,
  right,
  className = "",
}: CardFeaturingRowProps) {
  return (
    <div
      className={`grid grid-cols-[minmax(220px,1.5fr)_1fr_1fr_1fr_auto] items-center gap-8 ${className}`}
    >
      <AirlineMini
        logo={airline.logo}
