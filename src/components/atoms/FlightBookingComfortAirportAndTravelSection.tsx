            ...
            <div className="px-3 pb-3 mt-3">
                <div className="rounded-xl border border-[#E4E4E7] overflow-hidden">
                    ...
                    >
                        ...
                        <CardChevron open={openComfort} onClick={switchComfort} />
                    </button>

                    {openComfort && <div className="h-px bg-[#E4E4E7]" />}
            ...
            <div className="px-3 pb-3 mt-3">
                <div className="rounded-xl border border-[#E4E4E7] overflow-hidden">
                    ...
                    >
                        ...
                        <CardChevron open={openAirport} onClick={switchAirport} />
                    </button>
            ...
            <div className="px-3 pb-3 mt-3">
                <div className="rounded-xl border border-[#E4E4E7] overflow-hidden">
                    ...
                    >
                        ...
                        <CardChevron open={openProtection} onClick={switchProtection} />
                    </button>

                    {openProtection && <div className="h-px bg-[#E4E4E7]" />}
