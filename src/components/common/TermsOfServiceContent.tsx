...
const TermsOfServiceContent: React.FC = () => {
  return (
    <div className="w-full max-w-[578px] mx-auto">
      ...
      >
        Welcome to Al Rais Travels. By accessing our website, you agree to be
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          ...
          non-commercial temporary viewing only. Under this license, you may
          not:
        </p>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          The materials on Al-Rais's website are provided on an 'as is' basis.
          Al Rais makes no warranties, expressed or implied, and hereby
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          In no event shall Al-Rais Travel or its suppliers be liable for any
          damages (including, without limitation, damages for loss of data or
          profit, or due to business interruption) arising out of the use or
          inability to use the materials on the Al-Rais Travel website.
        </p>
      </div>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          ...
          typographical, or photographic errors. Al-Rais Travel does not warrant
          that any of the materials on our website are accurate, complete, or
          current. Al-Rais Travel may make changes to the materials on our
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          Al-Rais Travel has not reviewed all of the sites linked to our website
          and are not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement by Al-Rais Travel of
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          ...
          with the laws of United Arab Emirates, and you irrevocably submit to
