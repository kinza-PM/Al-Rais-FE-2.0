            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span
                    className="absolute right-3 top-7 -translate-y-1/2 text-sm text-gray-500 hover:text-gray-700 cursor-pointer"
                    aria-hidden="true"
