...
export default function TailwindCustomInput({
  ...
  const defaultClasses =
    ...
    (error
      ? "border-[#E65959] focus:border-[#E65959] focus:ring-[#E65959]/20"
      : "border-[#C2CAD6] focus:border-[#5383DA] focus:ring-[#5383DA]/20");

  const defaultLabelClass = "mb-1 block text-[12px] text-[#3D495C]";
