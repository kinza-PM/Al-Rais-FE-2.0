        ...
        <div className="flex footerFlexDirection">
          ...
          <div className="md:basis-1/3 lg:basis-2/5 pr-8">
            <img
              ...
              className="w-full max-w-[242px] mb-4"
            />
            <p className="text-gray-700 mb-2">
              Experience the true richness of travel with Al Rais Travel.
            </p>
            <p className="text-gray-700">
              Discover unforgettable journeys with Al Rais Travel, your gateway
              to the world.
            </p>
          </div>
          ...
          <div className="md:basis-2/3 lg:basis-3/5 flex gap-[34px] footerFlexDirection">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Book Flights", "Book Hotels", "Manage your bookings"].map(
                  (item) => (
                    <li key={item}>
                      <a
                        href="#"
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["FAQs", "Payments", "Contact us"].map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="text-gray-700 hover:text-blue-600 transition-colors"
