...
export default function FlightBookingETicketSection() {
        ...
        <div className="relative mt-7 mb-10 -mx-2">
            ...
            >
                <svg width="10" height="20" viewBox="0 0 10 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.5 0.512695C5.51429 0.772696 9.5 4.92101 9.5 10C9.5 15.079 5.51426 19.2263 0.5 19.4863V0.512695Z" fill="white" stroke="#C2CAD6" />
                </svg>
            </span>
            ...
            >
                <svg width="10" height="20" viewBox="0 0 10 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.5 0.512695C4.48571 0.772696 0.5 4.92101 0.5 10C0.5 15.079 4.48574 19.2263 9.5 19.4863V0.512695Z" fill="white" stroke="#C2CAD6" />
                </svg>
            </span>
        </div>
    ...
    const InstructionsCard = () => (
        <>
            <div className="rounded-2xl border border-[#E4E4E7] bg-white shadow-sm px-4 pt-4 pb-2">
                <div>
                    <InfoRow>
                        During various procedures in the airport, passengers must provide the valid ID used to purchase their
                        ticket. Their boarding pass or itinerary may also be required.
                    </InfoRow>
                    <InfoRow>
                        Please ensure that all passengers requiring special assistance contact the airline at least 48 hours prior
                        to departure.
                    </InfoRow>
                    <InfoRow>
                        Please note that tickets must be used in the sequence set out in the itinerary, otherwise airlines reserve
                        the right to refuse carriage. Al Rais Travels takes no responsibility if passengers are unable to board a
                        plane due to not complying with airline policies and regulations.
                    </InfoRow>
                    <InfoRow>
                        We suggest you to arrive at Dubai international airport at least 3h prior to departure to ensure you have
                ...
                <div className="grid grid-cols-[120px_1fr] gap-x-2 gap-y-2 [font-variant-numeric:tabular-nums]">
                    ...
                    <div className="text-[14px] font-medium text-[#0A0C0F] text-right">
                        45kg per person, dimensions of each piece cannot exceed 90×72×45cm
                    </div>

                    <div className="text-[12px] text-[#3D495C]">Checked baggage</div>
                    <div className="text-[14px] font-medium text-[#0A0C0F] text-right">No free baggage allowance</div>
                </div>
                ...
                <div className="pb-6 pt-2 flex flex-col items-center gap-2">
                    ...
                    <div className="mt-2 text-center font-medium text-[13px] text-[#3D495C]">
                        Thanks for choosing Al Rais.<br />Have a safe journey.
                    </div>
                </div>
                    ...
                    <div className="rounded-2xl border border-[#E4E4E7] bg-white shadow-sm px-4 pt-4 pb-2">
                        <div>
                            <div className="flex items-center justify-center gap-2 px-6">
                                ...
                                <p className="text-[13px] text-[#3D495C]">
                                    We advise you to print out your itinerary and take it with you to ensure your trip
                            ...
                            <div className="mt-4 mb-4 grid grid-cols-3 gap-10 sm:grid-cols-3">
                                ...
                                <div>
                                    <div className="text-[13px] text-[#3D495C]">Airline booking reference</div>
                                    <div className="text-[15px] font-medium text-[#0A0C0F]">
                                        AVTTYUI89OP
                                    </div>
                                </div>
                        ...
                        <div className="mt-4 mb-4 grid grid-cols-3 gap-10 sm:grid-cols-3">
                            <div>
                                ...
                                <div className="text-[15px] font-medium text-[#0A0C0F]">Mr. Zeeshan Ahmad</div>
                            </div>
                            <div>
                                <div className="text-[13px] text-[#3D495C]">Class</div>
                                <div className="text-[15px] font-medium text-[#0A0C0F]">Economy</div>
                            </div>
                            <div>
                                <div className="text-[13px] text-[#3D495C]">Seat</div>
                                <div className="text-[15px] font-medium text-[#0A0C0F]">B9 (Confirmed)</div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="grid grid-cols-3 flex justify-between gap-10">
                                <div className="flex items-center gap-2">
                                    <img
                                        src={EmirateLogo}
                                        alt="Emirates"
                                    ...
                                    />
                                    <div>
                                        <div className="text-[14px] text-nowrap font-medium text-[#0A0C0F]">Emirates Airlines</div>
                                        <div className="text-[12px] text-[#3D495C]">EK 1234</div>
                                    </div>
                                </div>

                                <div>
                                    <div className="text-[12px] text-[#3D495C]">Duration</div>
                                    <div className="text-[14px] font-medium text-[#0A0C0F]">3h 15m</div>
                                </div>
                                <div>
                                    <div className="text-[12px] text-[#3D495C]">Stops</div>
                                    <div className="text-[14px] font-medium text-[#0A0C0F]">Direct</div>
                                </div>
                            </div>
                            ...
                            <div className="py-4">
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[12px] text-[#3D495C]">23:15 • 05/Aug/2025 • Terminal 1 International</div>
                                    </div>
                                </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-[1fr_1.4fr]">
                            <div>
                                <div className="text-[13px] text-[#3D495C]">Passenger 01 (Adult)</div>
                                <div className="text-[16px] font-medium text-[#0A0C0F]">Mr. Zeeshan Ahmad</div>
                            </div>

                            <div className="[font-variant-numeric:tabular-nums]">
                                <div className="grid grid-cols-[1fr_auto] items-center gap-y-2">
                                    <div className="text-[12px] text-[#3D495C]">Personal item</div>
                                    <div className="text-[15px] font-medium text-[#0A0C0F] text-right">No free baggage allowance</div>

                                    <div className="text-[12px] text-[#3D495C]">Carry-on baggage</div>
                                    <div className="text-[15px] font-medium text-[#0A0C0F] text-right">1 piece per person, 7kg each</div>

                                    <div className="text-[12px] text-[#3D495C]">Checked baggage</div>
                                    <div className="text-[15px] font-medium text-[#0A0C0F] text-right">45kg per person</div>
                                </div>
                            </div>
                        </div>
