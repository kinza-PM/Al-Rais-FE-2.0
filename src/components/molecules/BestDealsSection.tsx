...
const DEALS: Deal[] = [
    { id: "1", title: "Switzerland", subtitle: "Grindelwald", image: Deal1, price: 98 },
    { id: "2", title: "France", subtitle: "Paris, France", image: Deal2, price: 197 },
    { id: "3", title: "United Kingdom", subtitle: "London, UK", image: Deal3, price: 178 },
            ...
            <div className="absolute inset-x-0 bottom-0 z-20 px-2 pb-3">
                ...
                <div className="mb-2 flex items-end justify-between text-white">
                    <div>
                        ...
                        <p className="text-[rgba(228,228,231,1)] text-[12px] leading-tight">Round-trip flights</p>
                        <p className="text-[rgba(228,228,231,1)] text-[12px] leading-tight">4 nights hotels</p>
                    </div>

                    <div className="text-right">
                        <p className="text-[rgba(228,228,231,1)] text-[12px] leading-tight">Starting from</p>
                        <p className="text-[rgba(228,228,231,1)] text-[16px] font-semibold leading-tight">${d.price}</p>
                    </div>
                </div>
