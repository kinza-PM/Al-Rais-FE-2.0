...
const HeroSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      //   setError(null);
      try {
        const resp: FlightTypesResponse = await getMasterListingData(
        ...
        // setError(
        //   e instanceof Error ? e.message : "Failed to load flight types"
        // );
      ...
      <div className="w-full flex justify-center px-4 mt-10">
        <div className="w-full max-w-[1040px] bg-white rounded-xl border border-[#E7EEF7] shadow-[0_8px_28px_rgba(12,40,86,0.08)]">
          ...
          <div className="px-6 pb-6 pt-6">
            {trip === "oneway" && <OneWayForm />}

            {trip === "roundtrip" && <RoundTripForm />}

            {trip === "multicity" && <MultiCityForm />}
            {/* Search */}
