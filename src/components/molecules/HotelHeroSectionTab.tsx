...
const HotelHeroSection: React.FC = () => {
  ...
  const [trvaellingForWork, setTravellingForWork] = useState(false);
    ...
    <div className="px-6 pb-6 pt-6">
      <div className="flex items-end gap-4">
        ...
        <div className="w-[270px]">
          ...
          />
          <div className="absolute mt-2 ml-2 text-[12px] text-[#3D495C]">
            <CustomToggle
              label="I’m traveling for work"
              checked={trvaellingForWork}
              onChange={() => setTravellingForWork((v) => !v)}
            />
          </div>
        </div>
