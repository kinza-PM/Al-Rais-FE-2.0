...
const HeroSection: React.FC = () => {
  ...
  // stable handlers to avoid child effects re-firing on every render
  ...
  // reset form state when trip tab changes
  useEffect(() => {
    // reset passengers, cabin, dates and routes
    setPaxCounts({});
    setPaxOrder([]);
