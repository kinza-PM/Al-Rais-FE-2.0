                ...
                <div className="cardBody">
                  ...
                  <div className="featureImgs">
                    <Row className="featureImgsFlex">
                      ...
                      <Col span={10} className="featureIconText">
                        ...
                        <p>Free in-flight meal</p>
                      </Col>
                      <Col span={8} className="featureIconText"></Col>
                      <Col span={12} className="featureIconText">
                  ...
                  <div className="flightSeats">
                    ...
                    <div className="SeatDetail">
                      ...
                      <div>
                        <p className="parahOne">Seats layout</p>
                        <p className="parahTwo">2-4-2</p>
                      </div>
                    </div>
                  </div>
                </div>
